...
<body id="page-top">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Data Entry</h1>
					</div>
							...
							<div class="card border-left-primary shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-6">
											<canvas id="dataEntryChart"></canvas>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												...
												<a href="dataEntry_Rooms"> Rooms </a>
											</div>
										</div>
										<div class="col-auto">
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">
												<a href="dataEntry_Servers"> Servers </a>
											</div>
										</div>
										<div class="col-auto">
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">
												<a href="dataEntry_Devices"> Sensor Devices </a>
											</div>
										</div>
										<div class="col-auto">
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">
												<a href="device_Adafruit"> Temperature and Humidity</a>
											</div>
										</div>
										<div class="col-auto">
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">
												<a href="device_Esp"> Water Leakage</a>
											</div>
										</div>
										<div class="col-auto">
											<i class="fa fa-database fa-2x text-gray-300"></i>
	...
	var totalRecordsRooms = parseInt("${roomsRecordsTotal}");
	var totalRecordsServers = parseInt("${serversRecordsTotal}");
	var totalRecordsDevices = parseInt("${devicesRecordsTotal}");
	var totalRecordsDeviceAdafruit = parseInt("${device_AdafruitRecordsTotal}");
	var totalRecordsDeviceEsp = parseInt("${device_EspRecordsTotal}");
	
	var ctx = document.getElementById("dataEntryChart").getContext('2d');
	  var myChart = new Chart(ctx, {
	      type: 'bar',
	      data: {
	          labels: ["Rooms", "Servers", "Sensor Devices","Temperature and Humidity","Water Leakage"],
	          datasets: [{
	              label: '# of Total Records',
	              data: [totalRecordsRooms, totalRecordsServers, totalRecordsDevices,totalRecordsDeviceAdafruit,totalRecordsDeviceEsp],
	              backgroundColor: [
	                  'rgba(255, 99, 132, 0.2)',
	                  'rgba(54, 162, 235, 0.2)',
	                  'rgba(255, 206, 86, 0.2)',
