				...
				<div class="container-fluid">
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col-auto">
											<div>
												<h4>Registration</h4>
												<form:form id="regRoomsForm"
													modelAttribute="dataEntry_Rooms"
													action="registerRoomsProcess" method="post">
													<table align="center">
														<tr>
															<td><form:label path="roomId">Room Id</form:label></td>
															<td><form:input path="roomId" name="roomId"
																	id="roomId" /></td>
														</tr>
														<tr>
														...
														<tr>
															<td><form:label path="serverId">Server Id</form:label>
															</td>
														...
														<tr>
															<td></td>
															<td><form:button id="registerRooms"
																	name="registerRooms">Register</form:button></td>
														</tr>
														<tr></tr>
													</table>
												</form:form>
					...
					<div>
						...
						<table class="table">
							...
							<tbody>
								<c:forEach items="${roomsData}" var="item">
									<tr>
										<td>${item.roomId}</td>
