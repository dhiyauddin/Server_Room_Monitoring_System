			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Water Leakage</h1>
					</div>
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col-auto">
											<div>
												<h4>Registration</h4>
												<form:form id="regDevice_EspForm"
													modelAttribute="device_Esp"
													action="registerDevice_EspProcess" method="post">
													<table align="center">
														<tr>
														...
														<tr>
															<td><form:label path="waterPresence">Water Presence</form:label></td>
															<td><form:input path="waterPresence"
																	name="waterPresence" id="waterPresence" /></td>
														</tr>
														<tr>
															<td></td>
															<td><form:button id="registerDevice_Esp"
																	name="registerDevice_Esp">Submit</form:button></td>
														</tr>
														<tr></tr>
													</table>
												</form:form>
					...
					<div>
						...
						<table class="table">
							...
							<tbody>
								<c:forEach items="${device_EspData}" var="item">
									<tr>
										<td>${item.deviceId}</td>
