			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Temperature and Humidity</h1>
					</div>
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col-auto">
											<div>
												<h4>Registration</h4>
												<form:form id="regDevice_AdafruitForm"
													modelAttribute="device_Adafruit"
													action="registerDevice_AdafruitProcess" method="post">
													<table align="center">
														<tr>
														...
														<tr>
															<td><form:label path="temperature">Temperature</form:label></td>
															<td><form:input path="temperature"
																	name="temperature" id="temperature" /></td>
														</tr>
														<tr>
															<td><form:label path="humidity">Humidity</form:label></td>
															<td><form:input path="humidity" name="humidity"
																	id="humidity" /></td>
														</tr>
														<tr>
															<td><form:label path="battery">Battery</form:label></td>
															<td><form:input path="battery" name="battery"
																	id="battery" /></td>
														</tr>
														<tr>
															<td></td>
															<td><form:button id="registerDevice_Adafruit"
																	name="registerDevice_Adafruit">Submit</form:button></td>
														</tr>
														<tr></tr>
													</table>
												</form:form>
					...
					<div>
						...
						<table class="table">
							...
							<tbody>
								<c:forEach items="${device_AdafruitData}" var="item">
									<tr>
										<td>${item.deviceId}</td>
