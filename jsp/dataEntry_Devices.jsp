								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col-auto">
											<div>
												<h4>Registration</h4>
												<form:form id="regDevicesForm"
													modelAttribute="dataEntry_Devices"
													action="registerDevicesProcess" method="post">
													<table align="center">
														<tr>
														...
														<tr>
															<td><form:label path="deviceType">Device Type</form:label></td>														
															<td><form:radiobutton path="deviceType" name="deviceType" value="201" />Temperature and Humidity</td>
															<td><form:radiobutton path="deviceType" name="deviceType" value="202" />Water Leakage</td>
														</tr>
														<tr>
															<td><form:label path="deviceDesc">Device Description</form:label></td>
															<td><form:input path="deviceDesc" name="deviceDesc"
																	id="deviceDesc" /></td>
														</tr>
														<tr>
															<td></td>
															<td><form:button id="registerDevices"
																	name="registerDevices">Register</form:button></td>
														</tr>
														<tr></tr>
													</table>
												</form:form>
